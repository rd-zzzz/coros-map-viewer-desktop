...
**Roads (`L` layer)**: Each class is drawn as a casing + fill pair — motorways/arterials are peach/salmon, secondary/local roads are white paved at high zoom and thin gray lines at low zoom, hiking trails (E29) are black dashed lines, railways are gray dashed lines, and metro/BRT lines are blue; widths are interpolated by zoom.
...
**Text labels**: Road names are dark gray, administrative and POI names dark red, peak names brown, all with a white halo.
